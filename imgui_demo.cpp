        ...
        if (ImGui::TreeNode("Key Ownership"))
        {
            ...
            if (ImGui::TreeNode("Usage Scenarios"))
            {
                ...
                if (ImGui::TreeNode("3. Claiming Alt shortcut"))
                {
                    ...
                    // - Passing 0 (== ImGuiKeyOwner_Any) means current loction will be used to identify.
                    ...
                    if (ImGui::Shortcut(ImGuiMod_Alt, use_shared_owner ? 0 : ImGui::GetItemID()))
                        value2++;
                ...
                if (ImGui::TreeNode("4. Claiming Home key globally"))
                {
                    ...
                    if (enable_home_robbery)
                    {
                        ...
                        if (ImGui::IsKeyPressed(ImGuiKey_Home, robber_id)) // We unconditionally own the key so no need to test for ownership
                            home_presses++;
                    }
                    ImGui::TreePop();
                }
                ...
                {
                    // Using a priority of ImGuiInputFlags_GlobalRoutingHigh means we takes away even from an active item (e.g. InputText)
                    ...
                    if (enable_ctrl_a_robbery)
                        ImGui::SetShortcutRouting(ImGuiMod_Ctrl | ImGuiKey_A, 0, ImGuiInputFlags_RouteGlobalHigh);
                ...
                if (ImGui::TreeNode("6. Disable ESC key from an InputText()"))
                {
                    static char buf[9];
                ...
                if (ImGui::TreeNode("7. Claiming ESC away from an InputText()"))
                {
                    static char buf[9];
                    ...
                    if (ImGui::IsItemActive())
                    {
                        ...
                        if (ImGui::Shortcut(ImGuiKey_Escape, robber_id, ImGuiInputFlags_RouteGlobalHigh))
                        {
                            strcpy(buf, "Esc!");
                            ImGui::ClearActiveID();
                        }
                ...
                if (ImGui::TreeNode("9. Claiming Tab, CTRL+Tab"))
                {
                    ...
                    HelpMarker("Showcasing many variants as a recap. Please read code and comments carefully!");
